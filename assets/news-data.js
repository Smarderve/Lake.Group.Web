window.LAKE_NEWS = [
  ...
  },
  {
    ...
    description: [
      ...
      "Despite initial regulatory hurdles . including a temporary rejection of the maiden shipment by the Kenya Bureau of Standards (KEBS) over odorant levels . the terminal has successfully navigated all legal and environmental challenges. Kenyan courts upheld Lake Gas's Environmental Impact Assessment (EIA) license in December 2025, clearing the path for full operations.",
    ...
    images: [
      ...
      "assets/images/lakegas/ops/cylinder-warehouse.jpg",
      "assets/images/lakegas/ops/worker-silas.jpg"
    ],
    video: null
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "The group operates a fleet of over 1,600 vehicles, 250+ fuel stations, and employs more than 30,000 people. Forbes Africa previously profiled the company as a $1 billion integrated energy platform in 2017.",
  ...
  },
  {
    ...
    images: [
      ...
      "assets/images/lakesteel/TA/photo_1.jpg"
    ],
    video: null
  },
  {
  ...
  },
  {
    ...
    description: [
      ...
      "Lake Oil Uganda will supply petroleum products to the Ugandan market, leveraging the group's existing supply chains and the Northern Corridor logistics route through Kenya.",
      "Lake Trans Uganda provides bulk fuel haulage and general cargo transport services, connecting the Kampala hub to regional markets including South Sudan and eastern DR Congo.",
      "[Source: Lake Group verified company data]"
    ],
    images: [],
    video: null
  },
  {
    ...
    images: [
      ...
      "assets/images/news/6/photo_4.jpg"
    ],
    video: null
  },
  {
    ...
    description: [
      ...
      "Lake Trans specializes in bulk liquid petroleum haulage for Lake Oil's distribution network as well as third-party clients. The fleet operates along major East African transport corridors, including the Central Corridor (Dar es Salaam . Zambia . DRC) and the Northern Corridor (Mombasa . Uganda . Rwanda).",
      "The expanded capacity enables the group to move over 1.2 million metric tons of cargo annually across the region, supporting both Lake Group subsidiaries and external commercial clients."
    ],
    images: [],
    video: null
  },
  {
    ...
    description: [
      ...
      "The partnership with Sino-Trucks builds on the strategic MOU signed in 2017 between Lake Group Founder Ally Edha Awadh and Chinese truck manufacturer Sinotruk during an official visit to China.",
      "The fleet expansion supports Lake Group's commitment to modernizing its transport infrastructure and ensuring reliable delivery of petroleum products and cargo across its 9-country operational footprint."
    ],
    images: [],
    video: null
  },
  ...
  },
  {
    ...
    description: [
      ...
      "Lake Steel's Kibaha mill, located in Visiga, Pwani Region, has an annual production capacity of approximately 100,000 metric tons of high-strength corrosion-resistant rebar . the first of its grade introduced in Tanzania.",
      "The court ruling reinforced Lake Steel's contract enforcement position and demonstrated the company's commitment to protecting its commercial interests while continuing to supply construction and infrastructure projects across Tanzania."
    ],
    images: [],
    video: null
  },
  {
    ...
    description: [
      ...
      "Each station features modern forecourt designs, automated fuel dispensers, convenience stores, and enhanced safety systems. The expansion brought Lake Oil's branded blue, white, yellow, and red stations to more communities across Tanzania.",
      "Lake Oil operates along the entire petroleum value chain . from importation and storage at its Kigamboni terminal to distribution via Lake Trans fleet and retail sales through its station network.",
      "[Source: Lake Group official website]"
    ],
    images: [],
    video: null
  },
  {
    ...
    description: [
      ...
      "Lake Buildings operates alongside Lake Group's other construction-related subsidiaries . Lake Steel (rebar), Lake Pipes (piping and fittings), Gulf Aggregates (quarry products), and GCCP . Lake Premix (ready-mix concrete) . offering clients a complete construction materials and services value chain.",
  ...
  },
  {
    ...
    description: [
      ...
      "In addition to sugar, Lake Agro's Yala Swamp operations focus on rice cultivation, contributing to Tanzania's food security and rice self-sufficiency goals. The division employs modern farming techniques and irrigation systems to maximize yields.",
      "Lake Agro represents Lake Group's commitment to diversifying beyond energy and logistics into agricultural value chains that support regional food security and sustainable development."
    ],
    images: [],
    video: null
  },
  {
    ...
    description: [
      ...
      "Lake Group has a long-standing commitment to gender inclusion, with women playing key roles across its energy, manufacturing, logistics, and administrative functions. The 2021 IWD celebration was part of the company's ongoing CSR programming.",
      "Previous IWD initiatives have included orphanage visits (2015, 2017), staff luncheons (2014), and community health support. The 2021 edition focused on community resilience during the COVID-19 recovery period."
    ],
    images: [],
    video: null
  },
  ...
  },
  {
    ...
    description: [
      ...
      "The retail expansion supported Lake Oil's strategy of building a vertically integrated petroleum business . from importation and terminal storage at the Kigamboni facility, through bulk distribution via Lake Trans, to retail sales through the company's own station network.",
      "The milestone of 50+ stations positioned Lake Oil as one of Tanzania's fastest-growing petroleum marketing companies, competing with established international and local brands in the downstream sector.",
      "[Source: Lake Group official company data]"
    ],
    images: [],
    video: null
  ...
  },
  {
    ...
    description: [
      ...
      "Lake Trans supported the Zambia expansion by extending its fuel haulage routes from Dar es Salaam through the Tunduma/Nakonde border crossing to Lusaka and Ndola, utilizing the Central Corridor transport route.",
      "The Zambia entry was part of Lake Group's broader regional growth strategy, which later expanded the company's country presence to 10 nations across East and Central Africa.",
      "[Source: Lake Group verified company data, Africa Energy Intelligence]"
    ],
    images: [],
    video: null
  },
  ...
  // ====== EXISTING NEWS (preserved with fixed dates where known) ======
  {
    id: 20,
    title: "Lake Group New Year Celebrations",
    date: "01 Jan, 2019",
    category: "Events",
    bannerImage: "assets/images/news/20/photo_1.jpg",
    description: [],
    images: [
      "assets/images/news/20/photo_2.jpg",
      "assets/images/news/20/photo_3.jpg",
      "assets/images/news/20/photo_4.jpg",
      "assets/images/news/20/photo_5.jpg",
      "assets/images/news/20/photo_6.jpg",
      "assets/images/news/20/photo_7.jpg",
      "assets/images/news/20/photo_8.jpg",
      "assets/images/news/20/photo_9.jpg",
      "assets/images/news/20/photo_10.jpg",
      "assets/images/news/20/photo_11.jpg"
    ],
    video: null
  },
  {
    ...
    date: "01 Jan, 2019",
    category: "Sports",
    bannerImage: "assets/images/news/19/photo_2.jpg",
    description: [],
    images: [
      "assets/images/news/19/photo_1.jpg",
      "assets/images/news/19/photo_3.jpg",
      "assets/images/news/19/photo_4.jpg",
      "assets/images/news/19/photo_5.jpg",
      "assets/images/news/19/photo_6.jpg",
      "assets/images/news/19/photo_7.jpg",
      "assets/images/news/19/photo_8.jpg",
      "assets/images/news/19/photo_9.jpg",
      "assets/images/news/19/photo_10.jpg",
      "assets/images/news/19/photo_11.jpg",
      "assets/images/news/19/photo_12.jpg",
      "assets/images/news/19/photo_13.jpg",
      "assets/images/news/19/photo_14.jpg",
      "assets/images/news/19/photo_15.jpg",
      "assets/images/news/19/photo_16.jpg",
      "assets/images/news/19/photo_17.jpg",
      "assets/images/news/19/photo_18.jpg",
      "assets/images/news/19/photo_19.jpg",
      "assets/images/news/19/photo_20.jpg"
    ],
    video: null
  },
  {
    ...
    date: "01 Jan, 2019",
    category: "Events",
    bannerImage: "assets/images/news/18/photo_1.jpg",
    description: [],
    images: [
      "assets/images/news/18/photo_2.jpg",
      "assets/images/news/18/photo_3.jpg",
      "assets/images/news/18/photo_4.jpg",
      "assets/images/news/18/photo_5.jpg",
      "assets/images/news/18/photo_6.jpg",
      "assets/images/news/18/photo_7.jpg",
      "assets/images/news/18/photo_8.jpg",
      "assets/images/news/18/photo_9.jpg",
      "assets/images/news/18/photo_10.jpg"
    ],
    video: null
  },
  {
  ...
  },
  {
    ...
    date: "01 Jan, 2018",
    category: "Events",
    bannerImage: "assets/images/news/15/photo_1.jpg",
    description: [],
    images: [
      "assets/images/news/15/photo_2.jpg",
      "assets/images/news/15/photo_3.jpg",
      "assets/images/news/15/photo_4.jpg",
      "assets/images/news/15/photo_5.jpg",
      "assets/images/news/15/photo_6.jpg",
      "assets/images/news/15/photo_7.jpg"
    ],
    video: null
  },
  {
  ...
  },
  {
    ...
    date: "23 Feb, 2014",
    category: "Events",
    bannerImage: "assets/images/news/12/photo_1.jpg",
    description: [
  ...
  },
  {
    ...
    date: "30 Nov, 2014",
    category: "Events",
    bannerImage: "assets/images/news/11/photo_1.jpg",
    description: [
  ...
  },
  {
    ...
    date: "08 Mar, 2015",
    category: "CSR",
    bannerImage: "assets/images/news/10/photo_1.jpg",
    description: [
      ...
      "Madina Orphanage Centre is owned by Kuluthum Yusufu, it has 67 children classing from Primary to Secondary schools. As it is overcrowded with children in Tandale 40 children stay in Bunju. Our vision is to extend our hand to reach not only Maldina Orphanage Centre but also other centres in Tanzania. We understand that we cannot end poverty but we can reduce it to a certain level."
    ],
    images: [],
    video: null
  },
  ...
  },
  {
    ...
    date: "2014",
    category: "LPG",
    bannerImage: "assets/images/news/8/photo_1.jpg",
    description: [],
    images: [],
  ...
  {
    id: 4,
    title: "International Women's Day (IWD) 2017 . Kigamboni Orphanage Visit",
    date: "08 Mar, 2017",
    category: "CSR",
    bannerImage: "assets/images/news/4/photo_1.jpg",
    description: [
      "This is to express many thanks to The Management team along with Lake Group Women's for cooperation and support that made this day happen.",
      "It was a wonderful day for Lake Group Women to have such a gathering with Orphans at Miami Pub hall with Kids from five Centers of Kigamboni District. Apart from having lunch together with these orphans, we provided them foodstuff, clothes, school items etc costing around Tsh 8Million.",
      "Guest of Honor of the event was Kigamboni DAS (District Administrative Secretary) Ms. Rose Muhando and team. The event was attended by Ward Representative Hon. Dotto Msawa."
    ],
    images: [
