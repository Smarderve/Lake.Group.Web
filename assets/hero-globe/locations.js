...
export const COUNTRY_LOCATIONS = {
  ...
  ke: { countryName: 'KENYA', flag: '🇰🇪', lat: -0.0236, lng: 37.9062, labelOffset: [14, -16], mobileLabelOffset: [18, -24], arcAltitude: 0.06 },
  ug: { countryName: 'UGANDA', flag: '🇺🇬', lat: 1.3733, lng: 32.2903, labelOffset: [-58, -20], mobileLabelOffset: [-64, -34], arcAltitude: 0.08 },
  rw: { countryName: 'RWANDA', flag: '🇷🇼', lat: -1.9403, lng: 29.8739, labelOffset: [-56, 4], mobileLabelOffset: [-82, 0], arcAltitude: 0.09 },
  bi: { countryName: 'BURUNDI', flag: '🇧🇮', lat: -3.3731, lng: 29.9189, labelOffset: [-64, 22], mobileLabelOffset: [-86, 28], arcAltitude: 0.10 },
  cd: { countryName: 'DR CONGO', flag: '🇨🇩', lat: -2.8628, lng: 23.6560, labelOffset: [-68, 4], mobileLabelOffset: [-86, 8], arcAltitude: 0.16 },
  zm: { countryName: 'ZAMBIA', flag: '🇿🇲', lat: -13.1339, lng: 27.8493, labelOffset: [-56, 22], mobileLabelOffset: [-64, 30], arcAltitude: 0.14 },
  mz: { countryName: 'MOZAMBIQUE', flag: '🇲🇿', lat: -18.6657, lng: 35.5296, labelOffset: [14, 18], mobileLabelOffset: [18, 28], arcAltitude: 0.18 },
  et: { countryName: 'ETHIOPIA', flag: '🇪🇹', lat: 9.1450, lng: 40.4897, labelOffset: [14, -16], mobileLabelOffset: [18, -24], arcAltitude: 0.20 },
  ae: { countryName: 'UAE', flag: '🇦🇪', lat: 23.4241, lng: 53.8478, labelOffset: [14, -16], mobileLabelOffset: [18, -24], arcAltitude: 0.28 },
};
