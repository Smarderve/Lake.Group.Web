...
```bash
npm run seed:metrics        # idempotent — creates the canonical group metrics (employees 10,000+, trucks 1,600+, stations 154, network locations 250+ across Africa, countries 10, nationalities 21, subsidiaries 18+) as PUBLISHED
