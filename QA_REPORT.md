...
- **Leadership names and tenures** — `leadership.html` names executives (Abdulrahman Mohamed, Khalid Mohamed, Juma Nuru, Nassoro Abubakari) beyond the founder/CEO. Per the research dataset (`scripts/_verified_lake_facts.md`), **only Ally Edha Awadh (Chairman & Group CEO) is verifiable from official Lake Group sources**; other executive names/titles/tenures could not be confirmed and must be validated by the client before launch.
...
- **Fleet-size conflict** — official Lake Group sources themselves conflict (600 / 700+ / 750 / 850+ vehicles). The site should consistently use "700+" (the about-page figure) per the facts dataset; worth a final editorial sweep.
