...
assert.match(sw, /const VERSION = 'v87-20260828-01'/);
...
console.log(`Cache lifecycle check: ${urls.length} precache entries validated; v87 network-first lifecycle controls present.`);
