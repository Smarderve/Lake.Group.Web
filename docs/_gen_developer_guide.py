...
PAGES_DETAIL = {
    ...
    "our-story.html": {
        ...
        "unique": "Not linked from main nav. i18n scripts loaded without defer. Uses assets/images/our-story/ images.",
        "css": "flagship.css, assistant.css",
...
Exports window.LakeSite with initReveal/initCounters. Calls LakeI18n.init() on DOMContentLoaded.""",
    ...
    "i18n-content.js": """Build artifact: window.__LAKE_I18N_CONTENT__ = { en, fr, sw, pt, es, ar }. ~1,442+ keys. Generated by scripts/build_i18n_content.py from scripts/_master_en.json + translation_dict.py.""",
...
""")
    ...
    toc_items = [
        ...
        ("8", "3D Hero Architecture (hero-globe)"),
...
""")
    ...
    stack_rows = [
        ...
        ("React 18 + react-globe.gl", "3D hero", "Homepage globe island (hero-globe); bundled to a classic IIFE for file:// compatibility"),
        ...
        ("Vercel", "Deployment", "CDN + HTTPS; vercel.json defines permanent redirects and cache headers"),
        ...
        ("esbuild (scripts/build_hero_globe.js)", "3D bundle", "Bundles React + react-globe.gl into hero-globe.bundle.js (IIFE)"),
        ("Self-hosted fonts", "Typography", "Inter, Bebas Neue, Playfair, Material Symbols — no Google Fonts CDN"),
        ("Payload 3 + Next.js 15", "Backend CMS", "Self-hosted headless CMS in backend/ — admin UI + REST API (see §41)"),
        ("PostgreSQL 16 (Docker)", "CMS database", "backend/ docker-compose — db-data + media-data volumes"),
    ]
...
<tr><td><code>assets/images/our-story/</code></td><td>Photography for our-story.html slideshow</td></tr>
...
<tr><td>swr-image</td><td>Stale-while-revalidate</td><td>n-slider, our-story, products/</td></tr>
...
<tr><td>assets/images/our-story/</td><td>our-story.html slideshow scenes</td><td>stale-while-revalidate</td></tr>
...
<p>Masonry layout (.gallery-masonry) with lightbox (#lightbox). Click handlers on .photo-card open full-size image. motion.js skip zone includes #lightbox.</p>""",
        "our-story.html": """
<p>Cinematic slideshow not in main nav. Eight scenes from assets/images/our-story/scene1-8.jpg. Auto-advance timer plus click/tap/Space/ArrowRight to advance. Full viewport .ose-stage. Can be embedded in about.html via #our-story-embed iframe.</p>""",
    }
    for fname in sorted(meta.keys()):
        m = meta[fname]
...
<h4>Events</h4>
<p>Dispatches <code>lake-i18n-applied</code> CustomEvent with detail.lang after each apply. hero-globe and assistant.js listen for this to refresh localized strings.</p>""",
        "sw.js": """
...
Script load order on index.html: i18n-content, i18n, site, flexsearch, assistant-kb, assistant, inline lazy 3D loader, pwa, motion. Notably absent from initial load: hero-globe.bundle.js (lazy), Leaflet, news-data.js. Organization JSON-LD in head provides rich search results for company name, founder, address, and social profiles.""",
...
""")
    ...
    faqs = [
        ...
        ("Why bundle hero-globe?", "ES module scripts are blocked under file://. esbuild produces a classic IIFE with React + react-globe.gl inlined (npm run build:hero-globe)."),
        ...
        ("What is archive/lake-3d/?", "Retired Next.js 3D prototype moved out of the tree. Not linked from production."),
...
def main():
    ...
    body_parts.append("""
<section id="sec-41" class="chapter page-break">
...
<section id="sec-42" class="chapter page-break">
...
<section id="sec-43" class="chapter page-break">
