...
function patchMount() {
  ...
  const logos = `  var SUBSIDIARY_LOGOS = [
    ...
    { src: 'assets/images/logos/companies/lake-pipes.png', alt: 'Lake Pipes', title: 'Lake Pipes', href: 'lake-pipes.html' },
    { src: 'assets/images/logos/companies/lake-premix-cement.png', alt: 'Lake Premix', title: 'Lake Premix', href: 'lake-premix-cement.html' },
    ...
    { src: 'assets/images/logos/companies/cross-country-developer-transparent.webp', alt: 'Cross Country', title: 'Cross Country', href: 'cross-country.html' },
    { src: 'assets/images/logos/companies/nexdrive-motors-logo.webp', alt: 'NexDrive Motors', title: 'NexDrive Motors', href: 'nextdrive-motors.html' },
