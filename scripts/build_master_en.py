...
SHARED_EN = {
    ...
    "nav.companies": "Our Companies \u25be", "mob.companies": "Our Companies",
    "nav.dd.energies": "Lake Energies", "nav.dd.manufacturing": "Manufacturing",
    "nav.dd.logisticsCos": "Logistics", "nav.dd.realEstate": "Real Estate",
    ...
    "nav.co.lakeBuildings": "Lake Buildings", "nav.co.lakePlastics": "Lake Plastics",
    "nav.co.lakeSteel": "Lake Steel", "nav.co.lakeCylinders": "Lake Cylinders",
    "nav.co.gulfAggregates": "Gulf Aggregates", "nav.co.atl": "ATL",
    "nav.co.lakePremixCement": "Lake Premix & Cement", "nav.co.aficd": "AFICD",
    "nav.co.aill": "AILL", "nav.co.lakeTrans": "Lake Trans",
    "nav.co.crossCountry": "Cross Country", "nav.co.oceanGalleria": "Ocean Galleria",
    "nav.co.lakeAgro": "Lake Agro",
    "nav.network": "Operations Map", "nav.africaMap": "Operations Map",
    ...
    "nav.africaMapShort": "Operations Map", "nav.historyShort": "History", "nav.csrShort": "CSR",
    "nav.investorsShort": "Investors", "nav.projectsShort": "Projects", "nav.aboutUs": "About Us",
    "mob.services": "Services", "mob.network": "Operations Map", "mob.company": "Company", "mob.more": "More",
    ...
    "hero.sub": "One of Africa's fastest-growing energy, logistics & construction conglomerates, operating across 9 countries with 30,000+ employees and 1,600+ trucks on the road.",
    ...
    "chat.reply.truck": "Lake Trans operates a fleet of 1,600+ trucks across East & Central Africa for bulk liquid haulage and general cargo.",
    ...
    "ose.s3.title": "to a fleet of<br><em>1,600+.</em>",
