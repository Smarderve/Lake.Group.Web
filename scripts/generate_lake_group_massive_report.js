...
async function main() {
  ...
  children.push(dataTable(["Client Category","Served By"], [["Government","Lake Oil, Lake Gas"],["Retail","Lake Oil (290+ fuel stations)"],["Industrial/Mining","Lake Oil, Lake Lubes"],["Aviation","Lake Aviation"],["Construction","GCCP, Gulf Aggregates, Lake Steel"],["Maritime","Lake Oil (bunkering)"],["Transport","Lake Trans, ATL"],["Agriculture","Lake Agro, Lake Oil"]]));
  children.push(emptyLine());
  children.push(new Paragraph({children:[new PageBreak()]}));
