...
const htmlOnly = [
  ...
  [
    ...
    '<li><a href="#sec-5">Services hub + company pages (lake-oil, lake-gas, lake-steel, lake-premix-cement, lake-trans, lake-lubes, aficd, atl, aill, lake-agro, lake-aviation, lake-buildings, lake-cylinders, lake-pipes, gulf-aggregates, cross-country, ocean-galleria)</a></li>',
  ],
