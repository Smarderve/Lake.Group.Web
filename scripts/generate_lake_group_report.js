    ...
    companies: [
      {
        ...
        desc: "Flagship company and one of Tanzania's top 5 petroleum distributors. Supplies petrol and diesel through 152 retail stations, bulk delivery, and strategic storage. Provides marine bunkering at the Port of Dar es Salaam.",
        countries: [
...
async function main() {
  ...
  children.push(mixedPara([
    ...
    { text: "Adding the Lake Oil core business (petroleum distribution, 152 stations, 9 countries) — previously reported at $1B revenue in 2017 and likely grown since — places the group's total estimated revenue well in excess of $1B as of 2026, consistent with its trajectory as one of East Africa's largest privately held conglomerates." },
  ]));
  children.push(emptyLine());
