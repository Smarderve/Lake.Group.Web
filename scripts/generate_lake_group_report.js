    ...
    companies: [
      {
        ...
        desc: "Flagship company and one of Tanzania's top 5 petroleum distributors. Supplies petrol and diesel through 500+ fuel stations, bulk delivery, and strategic storage. Provides marine bunkering at the Port of Dar es Salaam.",
        countries: [
...
async function main() {
  ...
  const keyFacts = [
    ...
    ["Fuel Stations", "500+ fuel stations"],
  ...
  const timeline = [
    ...
    ["2026", "Ocean Galleria Nears Completion / Current State", "East Africa's first waterfront luxury mall in Masaki, Dar es Salaam nears completion. Lake Group now spans 18+ companies across 5 sectors, with operations in 10+ countries, 500+ fuel stations, 1,600+ tanker trucks, and 30,000+ employees.", "Milestone"],
  ];
  ...
  const subFin = [
    ["Lake Oil", "Flagship", "Top 5 in Tanzania; 500+ fuel stations; storage in 4 countries; marine bunkering"],
  ...
  children.push(mixedPara([
    ...
    { text: "Adding the Lake Oil core business (petroleum distribution, 500+ fuel stations, 9 countries) — previously reported at $1B revenue in 2017 and likely grown since — places the group's total estimated revenue well in excess of $1B as of 2026, consistent with its trajectory as one of East Africa's largest privately held conglomerates." },
  ]));
  children.push(emptyLine());
