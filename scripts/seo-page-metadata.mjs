...
export const PAGE_METADATA = Object.freeze({
  ...
  "atl.html": {
    ...
    "description": "ATL Limited (Aluminum Trailers Ltd) - established 2019, Tanzania's aluminium fuel tanker and custom trailer manufacturer. Your trailer partner."
  },
  "careers.html": {
    "title": "Careers at Lake Group | Jobs in East Africa",
    "description": "Join over 30,000 professionals across 10+ nationalities at Lake Group. Explore career opportunities across our 18+ business verticals."
  },
  "contact.html": {
    "title": "Contact Us | Lake Group",
  ...
  "lake-agro.html": {
    "title": "Lake Agro | Agricultural Company | Lake Group",
    "description": "Lake Agro Ltd is a Lake Group agricultural company established in Zambia in 2017, with five farms, commercial crop production and livestock operations across Zambia and a Tanzania sugarcane project."
  },
  "lake-aviation.html": {
  ...
  "lake-group-financial-dashboard.html": {
    ...
    "description": "Lake Group financial dashboard . revenue metrics, growth trajectory, sector breakdown, and key investments across East Africa's leading conglomerate."
  },
  "lake-group-org-chart.html": {
    "title": "Lake Group . Organisational Chart",
  ...
  "leadership-ally-edha-awadh.html": {
    ...
    "description": "Ally Edha Awadh is the Founder and Chairman of Lake Group. Born and raised in Tanzania, he founded Lake Oil in 2006 and built Lake Group into one of East Africa's leading conglomerates."
  },
  "leadership.html": {
    "title": "Leadership | Lake Group",
    "description": "Meet the Lake Group leadership team. Explore dedicated profiles for executives across energy, manufacturing, logistics and agribusiness."
  },
  "media-center.html": {
  ...
  "ocean-galleria.html": {
    ...
    "description": "Waterfront Mall is a luxury waterfront lifestyle and shopping destination under development in Masaki, Dar es Salaam . redefining retail, dining and entertainment."
  },
  "offline.html": {
    "title": "You're Offline | Lake Group",
    "description": "You're offline — check your connection and retry. Lake Group: energy, logistics, manufacturing and agro across Africa."
  },
  "our-story.html": {
  ...
  "sustainability.html": {
    "title": "Sustainability | Lake Group",
    "description": "Environmental stewardship, clean cooking LPG access and sustainable operations across Lake Group."
  }
});
