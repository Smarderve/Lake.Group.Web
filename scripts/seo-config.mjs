...
export const COMPANY_ENTITIES = Object.freeze({
  ...
  'nextdrive-motors.html': { name: 'NextDrive Motors Limited', sector: 'Automotive', areaServed: 'East and Central Africa' },
});
...
export const SEARCH_INTENTS = Object.freeze({
  ...
  'nextdrive-motors.html': { entity: 'NextDrive Motors Limited', vertical: 'Automotive', primary: 'commercial vehicle sales and distribution', secondary: ['JAC pick-ups', 'Ashok Leyland trucks', 'SANY trucks', 'ATL trailers', 'after-sales support', 'fleet support'], geography: 'East and Central Africa', related: ['Lake Group', 'Assembly Tech Limited'], questions: ['What does NextDrive Motors provide?', 'What vehicles does NextDrive Motors sell?', 'Does NextDrive sell JAC vehicles?'] },
  ...
  'lake-agro.html': { entity: 'Lake Agro Limited', vertical: 'Agro Processing', primary: 'commercial agricultural operations', secondary: ['crop production', 'livestock and beef', 'maize', 'soya beans', 'wheat', 'sugarcane plantation', 'sugar manufacturing'], geography: 'Zambia and Tanzania', related: ['Lake Group'], questions: ['What does Lake Agro do?', 'What agricultural activities does Lake Agro undertake in Zambia?', 'Where is Lake Agro based?'] },
