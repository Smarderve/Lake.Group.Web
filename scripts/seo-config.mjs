...
export const SEARCH_INTENTS = Object.freeze({
  ...
  'lake-agro.html': { entity: 'Lake Agro Limited', vertical: 'Agro Processing', primary: 'agro processing and agricultural development', secondary: ['sugar manufacturing', 'integrated agriculture'], geography: 'Rufiji, Tanzania', related: ['Lake Group'], questions: ['What does Lake Agro do?'] },
